...
plot(sim_N_iter,mean(solving_times_vsN_b,2), 'Color', orange_color,'LineWidth', line_width)
plot(sim_N_iter,mean(solving_times_vsN_c,2), 'Color', blue_color, 'LineWidth', line_width)
...
pbaspect([3 1 1])
lgnd = legend({'Convex','Local'}, 'Location', 'NorthWest');
set(lgnd, 'Interpreter', 'Latex','FontSize', font_size);
